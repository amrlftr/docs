...
<CreditChip description="Returns information about an uncle by block number and index" />
  ...
  <ParamField query="action" type="string" initialValue="eth_getUncleByBlockNumberAndIndex">
    Set to `eth_getUncleByBlockNumberAndIndex` for this endpoint.
  </ParamField>
  <ParamField query="tag" type="string" initialValue="0xC63276">
    Block number in hex format.
  </ParamField>
  <ParamField query="index" type="string" initialValue="0x0">
