...
<CreditChip description="Returns information about a block by block number" />
  ...
  <ParamField query="action" type="string" initialValue="eth_getBlockByNumber">
    Set to `eth_getBlockByNumber` for this endpoint.
  </ParamField>
  <ParamField query="tag" type="string" initialValue="0x10d4f">
    Block number in hex format.
  </ParamField>
  <ParamField query="boolean" type="string" initialValue="true">
