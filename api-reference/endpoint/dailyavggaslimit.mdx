---
title: 'Get Daily Average Gas Limit'
description: 'Retrieve historical daily average gas limit.'
api: 'GET /v2/api'
keywords: ['daily average gas limit', 'gas limit stats']
---

import { chain } from '/snippets/custom-variables.mdx';
import { CreditChip } from '/snippets/jsx-snippet.jsx';

<CreditChip description="Returns the historical daily average gas limit" pro={true} />
  ...
  <ParamField query="action" type="string" initialValue="dailyavggaslimit">
