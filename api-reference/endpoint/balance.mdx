...
import { TryEndpointLink } from '/snippets/try-endpoint-link.jsx';

  <RequestExample>

```plaintext Try in Your Browser
https://api.etherscan.io/v2/api?chainid=1&module=account&action=balance&address=0xf5690ee572102ef19fa5d0452b71e395eaae3083&tag=latest&apikey=YourApiKeyToken
```
