...
import { TryEndpointLink } from '/snippets/try-endpoint-link.jsx';
  ...
  <TryEndpointLink href="https://api.etherscan.io/v2/api?chainid=1&module=account&action=balance&address=0xde0b295669a9fd93d5f28d9ec85e40f4cb697bae&tag=latest&apikey=YourApiKeyToken" />
