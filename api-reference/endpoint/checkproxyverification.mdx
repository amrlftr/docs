...
<CreditChip description="Checks the status of a proxy contract verification" />
  ...
  <ParamField query="action" type="string" initialValue="checkproxyverification">
    Set to `checkproxyverification` for this endpoint.
  </ParamField>
  <ParamField query="guid" type="string" initialValue="gwgrrnfy56zf6vc1fljuejwg6pelnc5yns6fg6y2i6zfpgzquz">
