...
import { polygonChain, polygonChainCurrency } from '/snippets/custom-variables.mdx';

Returns the {polygonChainCurrency} balance of a given address on {polygonChain}.

  <ParamField query="chainid" type="string" initialValue="somevalue" default="somevalue" placeholder="test">
