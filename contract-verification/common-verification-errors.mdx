...
<Info>
Both <a href="../api-reference/endpoint/getsourcecode"><code>getsourcecode</code></a> and <a href="../api-reference/endpoint/getabi"><code>getabi</code></a> return data for contracts verified via Similar Match.
</Info>
